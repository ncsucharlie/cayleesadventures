...
<div id="wrapper-content">
  <div class="container">
  <div id="main-content">
<?php if ( $winterdream_options_db['winterdream_display_site_description'] != 'Hide' ) { ?>
    <div class="content-headline">
      <h1 class="entry-headline"><?php bloginfo( 'description' ); ?></h1>
    </div>
<?php } ?>
    <section class="home-latest-posts<?php if ($winterdream_options_db['winterdream_post_entry_format'] == 'Grid - Masonry') { ?> js-masonry<?php } ?>">
