...
<?php if ( $winterdream_options_db['winterdream_display_meta_post_entry'] != 'Hide' ) { ?>
        <p class="post-meta">
...
<?php } ?>
        <div class="post-entry-content"><?php if ( $winterdream_options_db['winterdream_content_archives'] != 'Content' ) { ?><?php the_excerpt(); ?><?php } else { ?><?php global $more; $more = 0; ?><?php the_content(); ?><?php } ?></div>
    </article>