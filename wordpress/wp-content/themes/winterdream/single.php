...
<?php winterdream_get_display_image_post(); ?>
<?php if ( $winterdream_options_db['winterdream_display_meta_post'] != 'Hide' ) { ?>
        <p class="post-meta">
...
<?php endwhile; endif; ?>
<?php if ( $winterdream_options_db['winterdream_next_preview_post'] != 'Hide' ) { ?>
<?php winterdream_prev_next('winterdream-post-nav'); ?>
<?php } ?> 
